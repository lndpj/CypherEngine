...
struct pak_header_t {
    ...
    common::u32 header_size{ CYPHER_PAK_HEADER_SIZE };
    common::u32 endian_tag{ CYPHER_PAK_ENDIAN_TAG };
    common::u32 flags{ CYPHER_PAK_FORMAT_NONE };

    common::u64 archive_size{ 0u };
    common::u64 file_count{ 0u };

    common::u64 index_offset{ 0u };
    common::u64 index_size{ 0u };
    common::u64 string_table_offset{ 0u };
    common::u64 string_table_size{ 0u };
    common::u64 data_offset{ 0u };
    common::u64 data_size{ 0u };

    common::u64 archive_hash{ 0u };
